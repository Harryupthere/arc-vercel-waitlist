  ...
  const tabs = [
    {
      ...
      content: (
        <div>
          ...
          <ol>
            <li>These GTC govern your ("Customer") use of services provided by ARC Funding.</li>
            <li>By registering or using the services, you enter into a contract with ARC Funding, agreeing to these terms.</li>
            ...
            <li>ARC Funding does not provide services to individuals in restricted jurisdictions, those under international sanctions, or those with a financial crime or terrorism-related criminal record.</li>
            ...
            <li>ARC Funding does not provide investment services, advice, or recommendations. Any trading guidance from its staff is not considered investment advice, and the company is not responsible for such statements.</li>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <ol>
            <li>You can order services through the ARC Funding website by completing a registration or order form. After registration, login details for the Client Section and/or Trading Platform will be provided.</li>
            <li>Services include the Free Trial, ARC Funding Challenge, and Verification, each differing in scope. The Free Trial is limited and does not grant access to other services.</li>
            ...
            <li>Fees for the ARC Funding Challenge vary based on account size, risk level, and challenge conditions. Pricing details are available on the website, and individual discounts cannot be combined unless stated otherwise.</li>
            <li>Fees are for access to the ARC Funding Challenge and are non-refundable, even if you cancel, fail the challenge, or violate the GTC.</li>
            <li>If a customer disputes a paid fee (e.g., via chargeback), ARC Funding may suspend or deny future services at its discretion.</li>
            ...
            <li>ARC Funding may update service fees and parameters at any time, but changes will not affect already purchased services.</li>
            <li>Before submitting an order, you can review and edit details. Once submitted, you will receive a confirmation email. The ARC Funding Challenge contract is finalized upon payment.</li>
            <li>Customers are responsible for acquiring the necessary technical equipment and software to access services. ARC Funding does not guarantee compatibility with specific devices or browsers.</li>
            ...
            <li>If a customer places an unusually high number of orders in a short time, ARC Funding may issue a warning. If the behavior continues, orders may be suspended. If linked to Forbidden Trading Practices, further actions may be taken as outlined in Section 5 of the GTC.</li>
          </ol>
        </div>
      )
    },
    {
      ...
      content: (
        <div>
          ...
          <ol>
            <li>Fees for the ARC Funding Challenge are in euros, but payments can be made in other currencies listed on the website. If you pay in a different currency, conversion rates will apply.</li>
      ...
      content: (
        <div>
          ...
          <ol>
            ...
            <li>The number of ARC Funding Challenges and Verifications per Client Section may be limited based on initial capital and other parameters. Funds, performance, and service data cannot be transferred or combined between different products.</li>
            <li>Access credentials must not be shared. If registered as a business, employees/representatives may be granted access. Customers are responsible for all activity in their Client Section, and ARC Funding is not liable for misuse.</li>
            <li>The Client Section and Trading Platform may experience downtime for maintenance or other reasons. ARC Funding is not responsible for any loss of access, data, or content.</li>
      ...
      content: (
        <div>
          ...
          <ol>
            ...
            <li>ARC Funding is not responsible for how customers use demo trading data in real trading.</li>
            ...
            <li>
              ...
              <ul className="list-disc list-inside pl-5 space-y-1">
                ...
                <li>The ARC Funding Challenge begins when the first demo trade is opened.</li>
            ...
            <li>
              ...
              <ul className="list-disc list-inside pl-5 space-y-1">
                ...
                <li>If these conditions are met, ARC Funding grants access to the Verification phase for free. However, all trades must be closed before evaluation.</li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="list-disc list-inside pl-5 space-y-1">
                ...
                <li>Not violate ARC Funding's demo trading rules (e.g., forbidden practices in Clause 5.4).</li>
                ...
                <li>If these conditions are met, ARC Funding may recommend the customer for the ARC Funding Trader Program. However, this does not guarantee acceptance into the program.</li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="list-disc list-inside pl-5 space-y-1">
                ...
                <li>Failure to meet Verification requirements results in disqualification from the ARC Funding Trader Program.</li>
                <li>In both cases, accounts and services are canceled without a refund.</li>
                <li>ARC Funding is not responsible if the customer is rejected from the Trader Program.</li>
              </ul>
            </li>
          </ol>
        </div>
    ...
    },
    {
      ...
      title: '7 ARC Funding Trader',
      content: (
        <div>
          <h2>7. ARC Funding Trader</h2>
          <ol>
            <li> If a customer successfully completes both the ARC Funding Challenge and Verification, they may be offered a contract by a third-party company to join the ARC Funding Trader Program.</li>
            <li> ARC Funding does not control or guarantee any agreement between the customer and the third-party company.</li>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <ol>
            <li>
              <strong>Content Ownership & Usage:</strong> The ARC Funding website, services, and all content (texts, images, graphics, videos, etc.) are legally protected and owned by ARC Funding or its licensors. ARC Funding grants a limited, non-exclusive, and revocable permission to use the content only for personal use within the scope of the services provided.
            </li>
            <li>
              <strong>Trademarks & Intellectual Property:</strong> All logos, trade names, and trademarks are owned by ARC Funding or its licensors. Customers do not have permission to use them.
            </li>
            <li>
              <strong>Fair Dealing & Dispute Resolution:</strong> Both ARC Funding and the customer must act fairly and in good faith. Any disputes must be resolved according to these General Terms & Conditions (GTC) and applicable law.
            </li>
            <li>
              <strong>No Additional Rights Granted:</strong> Customers only have rights explicitly granted in the GTC and may not use ARC Funding's services or content beyond what is permitted.
            </li>
            <li>
              ...
              <ul className="list-disc list-inside ml-6 space-y-1">
                ...
                <li>Selling, renting, licensing, or redistributing ARC Funding’s services or content.</li>
                <li>Using bots or automation to collect data from the website.</li>
                <li>Employing any methods that may damage ARC Funding.</li>
              </ul>
            </li>
            <li>
